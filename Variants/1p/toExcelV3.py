...
init_file = '../../abr data/emna_g_exp' # Location of stored data
second_file = '/fun'
mid_file = '_exp'
end_file_name = '.p'
exp_dir_nums = []
...
titles3 = ['exp', 'func', 'number used', 'number excluded', 'extra excluded in variant 3']
...
workbook = xlsxwriter.Workbook('data_col_v3.xlsx') # First Excel file
workbook.use_zip64()
worksheet = workbook.add_worksheet('main data')
workbook2 = xlsxwriter.Workbook('excel_files/data_info_v3.xlsx') # Info Excel file
    ...
    for i in range(start_file, functions[e - 1] + 1):
        ...
        for j in range(0, len(exampleContents)):
            ...
            if len(best_gs) == 35:
                ...
                sec1 = (v3_array[0] + v3_array[1] + v3_array[2])/3
                sec2 = (v3_array[3] + v3_array[4] + v3_array[5])/3
                sec3 = (v3_array[6] + v3_array[7] + v3_array[8])/3
                best_of_3 = 0
                worst_of_3 = 0
                ...
                if sec1 > sec2 and sec1 > sec3:
                    worst_of_3_of_3 = sec1
                elif sec2 < sec1 and sec2 < sec3:
                    worst_of_3_of_3 = sec2
                else:
                    worst_of_3_of_3 = sec3
                    
                if (abs((best_of_3-worst_of_3_of_3)/worst_of_3_of_3) > difference):
                    total_used_v3 += 1
                    row += 1
                else:
                    extra_v3_ex += 1
        ...
        columnI += 1
        worksheet2.write(rowI,columnI,extra_v3_ex)
        columnI += 1
...
switchFile = pd.read_excel(r'data_col_v3.xlsx')
switchFile.to_csv(r'excel_files/data_col_v3.csv', index=None, header=True)
os.remove('data_col_v3.xlsx')
