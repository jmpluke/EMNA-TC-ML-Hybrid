...
popsize = 1000
model = "models/model_KNN_v3_3p.p"
...
pickle.dump(fits, open("pickles/results_KNN_v3_3p_fits.p", "wb"), protocol=4)
pickle.dump(thresholds, open("pickles/results_KNN_v3_3p_thresholds.p", "wb"), protocol=4)
print('fitnesses:')
print(fits)
...
to_add = 'KNN_v3_3p' # switch with different models
end_part = '_fits.p'
