...
pickle.dump(fits, open("pickles/results_DT_org_fits.p", "wb"), protocol=4)
pickle.dump(thresholds, open("pickles/results_org_thresholds.p", "wb"), protocol=4)
print('fitnesses:')
print(fits)