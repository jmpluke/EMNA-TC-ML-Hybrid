...
popsize = 1000
model = "models/model_LOG_v1_1p.p"
...
pickle.dump(fits, open("pickles/results_LOG_v1_1p_fits.p", "wb"), protocol=4)
pickle.dump(thresholds, open("pickles/results_LOG_v1_1p_thresholds.p", "wb"), protocol=4)
print('fitnesses:')
print(fits)
...
to_add = 'LOG_v1_1p' # switch with different models
end_part = '_fits.p'
