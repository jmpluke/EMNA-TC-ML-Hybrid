...
pickle.dump(fits, open("pickles/results_TF2_org_fits.p", "wb"), protocol=4)
pickle.dump(thresholds, open("pickles/results_TF2_org_thresholds.p", "wb"), protocol=4)
print('fitnesses:')
print(fits)