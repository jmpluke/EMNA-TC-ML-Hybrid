...
pickle.dump(fits, open("pickles/results_LOG_v0_fits.p", "wb"), protocol=4)
pickle.dump(thresholds, open("pickles/results_LOG_v0_thresholds.p", "wb"), protocol=4)
print('fitnesses:')
print(fits)
...
to_add = 'LOG_v0' # switch with different models
end_part = '_fits.p'
