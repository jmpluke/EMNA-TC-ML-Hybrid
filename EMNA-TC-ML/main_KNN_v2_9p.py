...
popsize = 1000
model = "models/model_KNN_v2_9p.p"
...
pickle.dump(fits, open("pickles/results_KNN_v2_9p_fits.p", "wb"), protocol=4)
pickle.dump(thresholds, open("pickles/results_KNN_v2_9p_thresholds.p", "wb"), protocol=4)
print('fitnesses:')
print(fits)