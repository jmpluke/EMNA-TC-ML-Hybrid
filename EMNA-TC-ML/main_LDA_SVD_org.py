...
popsize = 1000
model = "models/model_LDA_SVD_org.p"
...
pickle.dump(fits, open("pickles/results_LDA_SVD_org_fits.p", "wb"), protocol=4)
pickle.dump(thresholds, open("pickles/results_LDA_SVD_org_thresholds.p", "wb"), protocol=4)
print('fitnesses:')
print(fits)