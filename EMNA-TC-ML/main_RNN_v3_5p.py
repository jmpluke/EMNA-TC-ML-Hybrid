...
popsize = 1000
model = "models/model_RNN_V3_5p.p"
...
pickle.dump(fits, open("pickles/results_RNN_v3_5p_fits.p", "wb"), protocol=4)
pickle.dump(thresholds, open("pickles/results_RNN_v3_5p_thresholds.p", "wb"), protocol=4)
print('fitnesses:')
print(fits)