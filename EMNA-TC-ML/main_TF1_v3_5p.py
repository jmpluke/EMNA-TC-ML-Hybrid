...
pickle.dump(fits, open("pickles/results_TF1_v3_5p_fits.p", "wb"), protocol=4)
pickle.dump(thresholds, open("pickles/results_TF1_v3_5p_thresholds.p", "wb"), protocol=4)
print('fitnesses:')
print(fits)