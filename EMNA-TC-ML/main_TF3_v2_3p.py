...
pickle.dump(fits, open("pickles/results_TF3_v2_3p_fits.p", "wb"), protocol=4)
pickle.dump(thresholds, open("pickles/results_TF3_v2_3p_thresholds.p", "wb"), protocol=4)
print('fitnesses:')
print(fits)
...
to_add = 'TF3_v2_3p' # switch with different models
end_part = '_fits.p'
