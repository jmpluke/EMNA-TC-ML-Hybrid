...
popsize = 1000
model = "models/model_RNN_V3_11p.p"
...
pickle.dump(fits, open("pickles/results_RNN_v3_11p_fits.p", "wb"), protocol=4)
pickle.dump(thresholds, open("pickles/results_RNN_v3_11p_thresholds.p", "wb"), protocol=4)
print('fitnesses:')
print(fits)
...
to_add = 'RNN_v3_11p' # switch with different models
end_part = '_fits.p'
