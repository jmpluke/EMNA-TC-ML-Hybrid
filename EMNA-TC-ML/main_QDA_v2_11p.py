...
popsize = 1000
model = "models/model_QDA_v2_11p.p"
...
pickle.dump(fits, open("pickles/results_QDA_v2_11p_fits.p", "wb"), protocol=4)
pickle.dump(thresholds, open("pickles/results_QDA_v2_11p_thresholds.p", "wb"), protocol=4)
print('fitnesses:')
print(fits)
...
to_add = 'QDA_v2_11p' # switch with different models
end_part = '_fits.p'
