...
pickle.dump(fits, open("pickles/results_DT_v1_7p_fits.p", "wb"), protocol=4)
pickle.dump(thresholds, open("pickles/results_DT_v1_7p_thresholds.p", "wb"), protocol=4)
print('fitnesses:')
print(fits)